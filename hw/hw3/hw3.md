# OIM3690 Web Technologies - 2025 Fall - Homework 3
...
## 🧩 Part 1: Color & Font Switcher (10 points)
...
- (Optional) Sorting reorders only the currently visible (filtered/searched) cards.

### ❗ Important Requirement

You **must not** modify the given HTML file (`hw3-2-projects.html`).

- All behavior and logic must be implemented in `scripts/hw3-2.js`.
...
## 🂡 Part 3: Simple Blackjack Game (20 points)
...
- Card image filenames follow the pattern `AS.png`, `10H.png`, `QC.png` (A/J/Q/K for ranks; suits C, D, H, S).

---

## 🧠 Part 4: Open-Ended JavaScript Project (30 points)
...
## 🌐 Part 5: Chrome Extension Idea (10 points) (`hw3-chrome-extension-idea.md`)

In your `hw3-chrome-extension-idea.md`, propose a simple idea for a Chrome extension that utilizes JavaScript to enhance web browsing. Your proposal should include:

### 1. Extension Concept

Describe the purpose and functionality of your proposed extension. What problem does it solve or what enhancement does it provide to the user experience?

### 2. Key Features

List and briefly describe at least three key features your extension would have. You don't need to implement the extension; just describe how it would function.

### 3. Research

- Briefly research existing Chrome extensions that are similar to your idea. Mention at least one and explain how your extension would differ or improve upon it.
- If no similar extensions exist, explain why your idea is unique.

---

## 🤖 Part 6: Reflection – Development & AI Collaboration (`hw3-reflection.md`) (10 points)
